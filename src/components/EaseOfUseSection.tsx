  ...
  const points = [
    {
      ...
      desc: '복잡한 PC 프로그램이나 무거운 앱을 설치할 필요가 없습니다. 스마트폰에서 카카오톡 하듯 링크 하나만 인스타그램 프로필에 걸면 즉시 세팅이 끝납니다.',
      badge: '학습 비용 0원',
    },
    {
      icon: Headphones,
      title: '1:1 전담 매니저 무료 세팅 대행',
      desc: '스마트폰 조작이 낯선 원장님도 걱정 없습니다. 기존 인스타그램 계정과 가격표, 휴무일만 알려주시면 펫프론트 전담 매니저가 1:1로 직접 예약 링크를 완성해 드립니다.',
      badge: '화이트글러브 온보딩',
    },
    {
      icon: Gift,
    ...
    },
    {
      ...
      desc: '월 29,000원은 단순 지출이 아닙니다. 한 달에 노쇼 딱 1건(12~15만 원)만 막아도 월 구독료의 몇 배 이상이 내 통장에 고스란히 남습니다.',
      badge: '압도적 회수율',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="mt-3 text-slate-600 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto">
            새로운 시스템을 배우는 피로감과 월 비용 부담을 0으로 덜어드리기 위해,
            <br className="hidden md:inline" />
            펫프론트는 처음부터 1인 전문가의 관점으로 다르게 설계되었습니다.
          </p>
        </div>
        ...
        <div className="mt-12 bg-amber-500 rounded-3xl p-6 sm:p-8 text-white flex flex-col sm:flex-row items-center justify-between gap-6 shadow-lg shadow-amber-500/20">
          <div className="space-y-1 text-center sm:text-left">
            ...
            <p className="text-xs sm:text-sm text-amber-100 max-w-xl leading-relaxed">
              원하시는 예약 항목과 가격표만 전달해주시면 펫프론트 팀이 24시간 내에 완성된 전용 예약 링크를 카카오톡으로 보내드립니다.
            </p>
          </div>
