      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-slate-300 text-sm sm:text-base leading-relaxed">
            예약/CRM SaaS 락인을 시작으로 B2B 도매 커머스와 선정산 핀테크까지 1인 펫 비즈니스의 평생 파트너로 확장합니다.
          </p>
        </div>
        ...
        <div className="bg-slate-800/60 rounded-3xl p-6 sm:p-8 border border-white/10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-white/5 rounded-xl p-4 border border-white/5 space-y-1.5">
              ...
              <p className="text-xs text-slate-400">
                1인 샵을 위한 미용 샴푸, 가위, 훈련 보조도구 대량 사입 및 최저가 공동구매
              </p>
            </div>
            ...
            <div className="bg-white/5 rounded-xl p-4 border border-white/5 space-y-1.5">
              ...
              <p className="text-xs text-slate-400">
                예약 데이터를 기반으로 안전한 당일 즉시 선정산 및 1인 창업 자금 파이낸싱
              </p>
            </div>
          </div>
        </div>
